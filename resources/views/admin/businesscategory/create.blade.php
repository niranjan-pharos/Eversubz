...
<div class="modal custom-modal center-model fade" tabindex="-1" role="dialog" id="addModalBusinessCategory">
    <div class="modal-dialog right-side" role="document">
        <div class="modal-content right-content">
            <div class="modal-header">

                <h4 class="modal-title">Add Business Category Info</h4>
            ...
            <div class="modal-body">
                <form action="{{ route('businessCategory.store') }}" method="post" role="form" id="add_businesscategory" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="row">
