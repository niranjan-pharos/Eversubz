...
<div class="search-lists">
    <div class="search-lists">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#createMembers"
                            ...
                            <div class="tab-content tab-content1">
                                <div class="tab-pane show active" id="ngoListing">
                                    <div class="table table-responsive">
                                        <table class="table custom-table mb-0" id="MembersTable">
                                            <thead>
                                                <tr>
                                                    <th>Actions</th>
                                                    <th>Image</th>
                                ...
                                <div class="tab-pane" id="createMembers">
                                    <form action="{{ route('ngo.member.store') }}" enctype="multipart/form-data"
                                        method="post" role="form" id="add_member">
                                        @csrf
                                        <div class="col-md-12">
                                            <div class="row">
        ...
        <div class="modal custom-modal fade" tabindex="-1" role="dialog" id="removeModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form role="form" action="{{ route('member.delete') }}" method="post" id="removeForm">
                        @csrf
                        @method('DELETE')
                        <div class="modal-body">
                        ...
                        <div class="modal-footer modal-footer-uniform">
                            <button type="submit" class="btn btn-danger submit-btn">Delete Member</button>
                        </div>
                    </form>>
                    </form>
        ...
        var ngoTable;
        $(document).ready(function() {
            ngoTable = $('#MembersTable').DataTable({
                'ajax': base_url + "/ngo-members/" + ngo_id + "/list", 
                'order': [],
            });
            ...
            if (id) {
                ...
                $("#removeForm").on('submit', function(event) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function(response) {
                            ngoTable.ajax.reload(null, false);
