...
<style>
                ...
                <div class="row">
                    <div class="col float-right ml-auto">
                        <button class="btn btn-primary add-btn add-button" data-bs-toggle="modal"
                            data-bs-target="#addModalEventCategory"><i class="fa fa-plus"></i> Add Event Category </button>
                    </div>
                    <div class="col-md-12">
                        <div class="card mb-0">
                            <div class="card-body">
    ...
    <!-- edit modal -->
    <div class="modal custom-modal fade" tabindex="-1" role="dialog" id="editEventForm">
        <div class="modal-dialog" role="document">
            ...
            <form class="form form-validate" role="form" action="{{ route('eventTicketCategoryUpdate') }}" method="post" id="updateEventForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                    <div class="row">
    ...
    <div class="modal custom-modal fade" tabindex="-1" role="dialog" id="removeModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form role="form" action="{{ route('eventTicketCategoryDelete') }}" method="post" id="removeForm">
                    @csrf
                    @method('DELETE')
                    <div class="modal-body">                   
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        categoryTable = $('#categoryTable').DataTable({
            'ajax': "{{ route('eventTicketCategoryList') }}",
            'order': []
        });
        ...
        $("#add_event_ticket_category").unbind('submit').on('submit', function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === true) {
                        ...
                        $("#addModalEventCategory").modal('hide');

                        $("#add_event_ticket_category")[0].reset();
                        $("#add_event_ticket_category .form-group").removeClass('has-error').removeClass('has-success');
    ...
    function editFunc(id) {
        var baseUrl = '{{ url('/') }}';
        $.ajax({
            url: baseUrl + "/admin/event/ticket-category/" + id + "/edit",
            type: 'get',
            dataType: 'json',
            success: function(response) {
                ...
                $("#updateEventForm").unbind('submit').bind('submit', function() {
                    event.preventDefault(); 
                    var form = $(this); 
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success === true) {
                                ...
                                $("#updateEventForm .form-group").removeClass('has-error').removeClass('has-success');
...
@include('admin.events.ticket-category.create')
@endsection
