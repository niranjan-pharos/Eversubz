            ...
            <table style="width:100% !important;border-collapse:collapse;">
                <tr>
                    <td class="masthead" style="text-align:center; padding-top: 40px; padding-bottom: 30px; padding-right: 0; padding-left: 0;
                        ...
                        <a href="#"><img class="email-logo" src="{{ asset('assets/images/logo.png') }}" alt="logo"
                                style="width: 100px; background: #fff; border-radius: 10px; padding: 5px;"></a>
                        <h1 style="line-height: 1.25; font-size: 32px; margin-top: 0 !important; margin-bottom: 0 !important;
                        margin-right: auto !important; margin-left: auto !important; max-width: 90%;">Eversabz Account Deletion Requesr Received</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="content"
                        ...
                        <h2
                            ...
                            Dear, {{ $user->name }}!</h2>
                        <p>Your request to delete your account has been processed. Your account has been marked as inactive and you will no longer be able to log in.</p>
                        <p>If this was a mistake, please contact <a href="mailto:info.eversabz@gmail.com"> support</a> immediately.</p>
