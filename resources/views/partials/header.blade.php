    ...
    <div class="flex items-center w-full max-lg:gap-3 xl:px-6">
        <div class="2xl:w-[--w-side] lg:w-[--w-side-sm]">
            ...
            <div class="flex items-center gap-1">
                <button id="toggle-button"
                    class="flex items-center justify-center text-xl rounded-full hover:bg-gray-100 xl:hidden  group mobile-widget  search-btn tab-toggle-button">
                ...
                <div id="logo">
                    <a href="/">
                        <img loading="eager" src="{{ asset('main_assets/images/logo.png') }}" alt="Eversabz logo"
                            class="w-24 img12">
        ...
        <div class="flex-1 relative">
            ...
            <div class="max-w-[1220px] mx-auto flex items-center">
                ...
                <div id="mobile-search-box" class="absolute right-0 hidden mt-2 overflow-hidden z-20 w-full max-w-md">
                ...
                <div
                    ...
                    <a href="{{ asset('ad-post/create') }}"
                        class="sm:p-2 p-1 max-sm:hidden rounded-full relative sm:bg-secondery "><svg
                    ...
                    <button class="p-2 p-1 md:hidden rounded-full relative bg-secondery  search-btn"
                    ...
                    <div class="relative ">
                        <button id="menu2" class="p-2 p-1  rounded-full relative bg-secondery " aria-haspopup="true"
                            aria-expanded="false">
                            <svg fill="#000000" width="24px" height="24px" viewBox="0 0 32 32"
                    ...
                    <div class=" dropdown-toggle1 header-widget">
                    ...
                    <div class="hidden bg-white rounded-lg drop-shadow-xl  w-64 border2"
                        ...
                        <div class="p-4 py-5 flex items-center gap-4 header-widget">
                            ...
                            @if(!empty(Auth::user()->image))
                            <img loading="eager" src="{{ asset('storage/'.Auth::user()->image) }}"
                                alt="{{ Auth::user()->username }}" class="w-10 h-10 rounded-full shadow">
                            @else
                            <img loading="eager" src="{{ asset('assets/images/user-image1.png') }}"
                                alt="{{ Auth::user()->username }}">
                            @endif
...
<div id="site__sidebar"
    ...
    <div
        class="p-2 max-xl:bg-white shadow-sm 2xl:w-72 sm:w-64  h-[calc(100vh-64px)] relative z-30 max-lg:border-r  sidebar-inner">
        ...
        <div class="pr-4" data-simplebar>
            ...
            <div class="text-xs font-medium flex flex-wrap gap-2 gap-y-0.5 p-2 mt-2 sidebar-inner-footer">
    ...
    fetch("{{ route('mini.cart') }}")
        ...
        .then(data => {
            ...
            if (data.items.length === 0) {
                menu.innerHTML = '<li class="px-4 py-2">Cart is empty.</li>';
                return;
            }
            ...
            totalLi.className = 'px-4 py-2 font-bold';
            totalLi.innerHTML =
                `<div class="flex justify-between"><span>Total:</span><span>$${data.total}</span></div>`;
            menu.appendChild(totalLi);
        });
}
</script>
