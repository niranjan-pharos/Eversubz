...
@section('content')
    ...
    <div class="modal custom-modal fade" tabindex="-1" role="dialog" id="editModal">
        <div class="modal-dialog" role="document">
            ...
            <form class="form form-validate" role="form" action="{{ route('eventCategoryUpdate') }}" method="post" id="updateForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                    <div class="row">
    ...
    <div class="modal custom-modal fade" tabindex="-1" role="dialog" id="removeModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form role="form" action="{{ route('eventCategoryDelete') }}" method="post" id="removeForm">
                    @csrf
                    @method('DELETE')
                    <div class="modal-body">                   
    ...
    function editFunc(id) {
        var baseUrl = '{{ url('/') }}';
        $.ajax({
            url: "{{ url('admin/event-category') }}/" + id + "/edit",
            type: 'get',
            dataType: 'json',
            success: function(response) {
...
@include('admin.eventscategory.create')
@endsection
