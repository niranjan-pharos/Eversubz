...
<div class="modal custom-modal center-model fade" tabindex="-1" role="dialog" id="addModalSkill">
    <div class="modal-dialog right-side" role="document">
        <div class="modal-content right-content">
            <div class="modal-header">

                <h4 class="modal-title">Add Skill Info</h4>
            ...
            <div class="modal-body">
                <form action="{{ route('storeSkill') }}" method="post" role="form" id="add_skill" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-12">
                        <div class="row">
