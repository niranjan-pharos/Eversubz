	...
	if (input) {
		messages.innerHTML += `
			<div class="d-flex justify-content-end align-items-end mb-3">
				...
				<div>
					<div class="w-35px h-35px my-1px ms-2 me-2 rounded-circle text-white bg-dark d-flex align-items-center justify-content-center">
						S
					</div>
				</div>
			</div>
		...
		setTimeout(() => {
			...
			aiMessage.innerHTML = `
				<div class="d-flex justify-content-start align-items-end">
					<div>
						<div class="w-35px h-35px my-1px ms-2 fs-16px me-2 rounded-circle bg-theme text-theme-color d-flex align-items-center justify-content-center">
