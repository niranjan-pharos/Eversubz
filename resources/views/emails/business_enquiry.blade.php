            ...
            <table style="width:100% !important;border-collapse:collapse;">
                <tr>
                    <td class="masthead" style="text-align:center; padding-top: 40px; padding-bottom: 30px; padding-right: 0; padding-left: 0;
                        ...
                        margin-right: auto !important; margin-left: auto !important; max-width: 90%;">Event Enquiry</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="content"
                        ...
                        <h2
                            ...
                            <h2>Hello {{ $enquiry->author_name }},</h2>
                            <p>Good news! One of our users is interested in your Business.</p>
                            <p>Here are the details of the interested user:</p>
                            <p><strong>Name:</strong> {{ $enquiry->name }}</p>
                            <p><strong>Email:</strong> {{ $enquiry->email }}</p>
                            <p><strong>Phone:</strong> {{ $enquiry->phone }}</p>
                            <p><strong>Description:</strong> {{ $enquiry->description }}</p>
                            <p>If you have any questions, please feel free to get in touch with user.</p>
                        <p><a title=" User login" class="trbtn" href="{{ route('user.login') }}"
