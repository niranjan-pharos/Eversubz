                    ...
                    <td style="background: linear-gradient(135deg, #2660C5 0%, #4285f4 100%); padding:0; text-align:center;">
                        ...
                        <div style="padding:0 20px 40px;">
                            ...
                            <p style="margin:10px 0 0; font-size:16px; color:rgba(255,255,255,0.9); font-weight:400;">
                                System notification for order tracking
                            </p>
                        </div>
                    ...
                    <td class="content" style="padding:40px; background-color:white; color:#333333; font-size:16px; line-height:1.6;">
                        ...
                        <div style="background: linear-gradient(135deg, #f8faff 0%, #f1f5ff 100%); 
                            ...
                            <h2 style="margin:0 0 15px; font-size:22px; font-weight:600; color:#2660C5; display:flex; align-items:center; justify-content:center;">
                                <span style="margin-right:8px;">⚡</span> Admin Dashboard Alert
                            </h2>
                            <p style="margin:0; color:#666; font-size:16px; text-align:center;">
                                A new order has been placed in the system. Review the transaction details and monitor order fulfillment process.
                            </p>
                        </div>
                        ...
                        <div style="background: linear-gradient(135deg, #f8faff 0%, #f1f5ff 100%); 
                            ...
                            <h3 style="margin:0 0 20px; font-size:18px; font-weight:600; color:#2660C5; display:flex; align-items:center; justify-content:center;">
                                <span style="margin-right:8px;">📊</span> Order Overview
                            </h3>
                            
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size:15px;">
                                <tr>
                                    <td style="padding:8px 0; color:#333; font-weight:500;">Order ID:</td>
                                    <td style="padding:8px 0; color:#666; text-align:right; font-family:monospace;">{{ $order->order_product_unique_id }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:8px 0; color:#333; font-weight:500;">Transaction Date:</td>
                                    <td style="padding:8px 0; color:#666; text-align:right;">{{ \Carbon\Carbon::parse($order->created_at)->format('M d, Y - h:i A') }}
</td>
                                </tr>
                                <tr>
                                    <td style="padding:8px 0; color:#333; font-weight:500;">Order Value:</td>
                                    <td style="padding:8px 0; color:#2660C5; text-align:right; font-weight:600; font-size:16px;">${{ number_format($total, 2) }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:8px 0; color:#333; font-weight:500;">Payment Status:</td>
                                    <td style="padding:8px 0; color:#28a745; text-align:right; font-weight:600;">Confirmed</td>
                                </tr>
                                <tr>
                                    <td style="padding:8px 0; color:#333; font-weight:500;">Order Status:</td>
                                    <td style="padding:8px 0; color:#ffc107; text-align:right; font-weight:600;">Pending Processing</td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div style="background: linear-gradient(135deg, #f8faff 0%, #f1f5ff 100%); 
                            ...
                            <h3 style="margin:0 0 20px; font-size:18px; font-weight:600; color:#2660C5; display:flex; align-items:center; justify-content:center;">
                                <span style="margin-right:8px;">👥</span> Customer Summary
                            </h3>
                            
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size:15px;">
                                <tr>
                                    <td style="padding:8px 0; color:#333; font-weight:500;">Customer Name:</td>
                                ...
                                <tr>
                                    <td style="padding:8px 0; color:#333; font-weight:500;">Location:</td>
                                    <td style="padding:8px 0; color:#666; text-align:right;">{{ $order->city }}, {{ $order->state }}</td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div style="background: linear-gradient(135deg, #f8faff 0%, #f1f5ff 100%); 
                            ...
                            <h3 style="margin:0 0 20px; font-size:18px; font-weight:600; color:#2660C5; display:flex; align-items:center; justify-content:center;">
                                <span style="margin-right:8px;">💰</span> Financial Breakdown
                            </h3>
                            ...
                            <div style="background:#fff; border-radius:8px; padding:20px; border:1px solid #e1e1e1;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                        <td style="padding:8px 0; color:#333; font-size:15px; font-weight:500;">Platform Fee (3%):</td>
                                        <td style="padding:8px 0; color:#666; text-align:right; font-size:15px;">${{ number_format($total * 0.03, 2) }}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding:15px 0 5px 0; border-top:2px solid #2660C5; color:#333; font-size:18px; font-weight:700;">Total Revenue:</td>
                        ...
                        <div style="background: linear-gradient(135deg, #d4edda 0%, #c3e6cb 100%); 
                                    border-left:4px solid #28a745; border-radius:12px; padding:25px; margin:30px 0; 
                                    box-shadow: 0 4px 15px rgba(40, 167, 69, 0.2);">
                            
                            <h3 style="margin:0 0 15px; font-size:18px; font-weight:600; color:#155724; display:flex; align-items:center; justify-content:center;">
                                <span style="margin-right:8px;">🚀</span> Quick Actions
                            </h3>
                            
                            <div style="display:flex; justify-content:center; gap:15px; flex-wrap:wrap;">
                                <a href="https://eversabz.com/admin/orders/{{ $order->id }}" style="display:inline-block; background:#2660C5; color:#ffffff; text-decoration:none; padding:12px 24px; font-size:14px; border-radius:25px; font-weight:600; margin:5px;">
                                    View Order Details
                                </a>
                                <a href="https://eversabz.com/admin/customers/{{ $order->user_id }}" style="display:inline-block; background:#28a745; color:#ffffff; text-decoration:none; padding:12px 24px; font-size:14px; border-radius:25px; font-weight:600; margin:5px;">
                                    Customer Profile
                                </a>
                                <a href="https://eversabz.com/admin/analytics" style="display:inline-block; background:#ffc107; color:#333; text-decoration:none; padding:12px 24px; font-size:14px; border-radius:25px; font-weight:600; margin:5px;">
                                    Sales Analytics
                                </a>
                            </div>
                        </div>
                    ...
                    <td style="padding:0 40px 40px;">
                        <div style="background: linear-gradient(135deg, #f8faff 0%, #f1f5ff 100%); 
                            ...
                            <p style="margin:0 0 15px; font-size:14px; color:#666;">
                                This is an automated system notification for order management and tracking purposes.
                            </p>
                            
                            <div style="border-top:1px solid #e0e6ff; padding-top:15px; margin-top:15px;">
                                <p style="margin:0; font-size:12px; color:#999; line-height:1.5;">
                                    © 2025 Eversabz Admin Panel. All rights reserved.<br>
                                    System ID: EVS-{{ date('Ymd') }}-{{ $order->id }}
                                </p>
                            </div>
                        </div>
                    </td>
