                    ...
                    <div class="message-filter">
                        ...
                        <ul class="message-list">
                            <li class="message-item unread"><a href="message.html" class="message-link">
                                    <div class="message-img active"><img src="assets/images/avatar/01.jpg" alt="avatar"></div>
                            ...
                            <li class="message-item"><a href="message.html" class="message-link">
                                    <div class="message-img active"><img src="assets/images/avatar/03.jpg" alt="avatar"></div>
                                    <div class="message-text">
                            ...
                            <li class="message-item unread"><a href="message.html" class="message-link">
                                    <div class="message-img"><img src="assets/images/avatar/02.jpg" alt="avatar"></div>
                                    <div class="message-text">
                            ...
                            <li class="message-item"><a href="message.html" class="message-link">
                                    <div class="message-img active"><img src="assets/images/avatar/04.jpg" alt="avatar"></div>
                                    <div class="message-text">
                            ...
                            <li class="message-item"><a href="message.html" class="message-link">
                                    <div class="message-img"><img src="assets/images/user.png" alt="avatar"></div>
                                    <div class="message-text">
                            ...
                            <li class="message-item"><a href="message.html" class="message-link">
                                    <div class="message-img active"><img src="assets/images/avatar/02.jpg" alt="avatar"></div>
                                    <div class="message-text">
                    ...
                    <div class="message-inbox">
                        ...
                        <ul class="inbox-chat-list">
                            <li class="inbox-chat-item">
                                <div class="inbox-chat-img"><img src="assets/images/avatar/01.jpg" alt="avatar"></div>
                            ...
                            <li class="inbox-chat-item my-chat">
                                <div class="inbox-chat-img"><img src="assets/images/avatar/02.jpg" alt="avatar"></div>
                                <div class="inbox-chat-content">
                                    <div class="inbox-chat-text">
