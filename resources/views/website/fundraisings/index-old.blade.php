...
<div class="2xl:max-w-[1220px] max-w-[1065px] mx-auto">
    ...
    <div class="uk-switcher" id="group-tabs">
        ...
        <div class="relative" tabindex="-1" uk-slider="auto play: true;finite: true">
            ...
            <div class="uk-slider-container pb-1">
                ...
                <ul class="uk-slider-items w-[calc(100%+14px)]"
                    ...
                    <li class="pr-3 md:w-1/4 w-1/2" uk-scrollspy-class="uk-animation-fade">
                        <div class="card">
                            <a href="timeline-group.html">
                                <div class="card-media h-24">
                                    <img src="main_assets/images/group/group-cover-4.jpg" alt="">
                                    <div class="card-overly"></div>
                                </div>
                            </a>
                            <div class="card-body relative z-10">
                                <img src="main_assets/images/avatars/avatar-4.jpg" alt=""
                                    class="w-10 rounded-full mb-2 shadow -mt-8 relative border-2 border-white">
                                <a href="timeline-group.html">
        ...
        <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-2.5">
            ...
            <div class="card">
                <a href="timeline-group.html">
                    <div class="card-media h-24">
                        <img src="main_assets/images/product/product-1.jpg" alt="">
                        <div class="card-overly"></div>
                    </div>
                </a>
                <div class="card-body">
                    ...
                    <div class="card-text">
                        ...
                        <div class="flex items-center gap-3 mt-3">
                            <div class="flex -space-x-2">
                                <img src="main_assets/images/avatars/avatar-2.jpg" alt=""
                                    class="w-6 rounded-full border-2 border-white">
                                <img src="main_assets/images/avatars/avatar-3.jpg" alt=""
                                    class="w-6 rounded-full border-2 border-white">
                                <img src="main_assets/images/avatars/avatar-7.jpg" alt=""
                                    class="w-6 rounded-full border-2 border-white">
                            </div>
            ...
            <div class="card">
                <a href="timeline-group.html">
                    <div class="card-media h-24">
                        <img src="main_assets/images/product/product-2.jpg" alt="">
                        <div class="card-overly"></div>
                    </div>
                </a>
                <div class="card-body">
            ...
            <div class="card">
                <a href="timeline-group.html">
                    <div class="card-media h-24">
                        <img src="main_assets/images/product/product-4.jpg" alt="">
                        <div class="card-overly"></div>
                    </div>
                </a>
                <div class="card-body">
            ...
            <div class="card">
                <a href="timeline-group.html">
                    <div class="card-media h-24">
                        <img src="main_assets/images/product/product-3.jpg" alt="">
                        <div class="card-overly"></div>
                    </div>
                </a>
                <div class="card-body">
        ...
        <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-2.5">
            ...
            <div class="card">
                <a href="timeline-group.html">
                    <div class="card-media h-24">
                        <img src="main_assets/images/group/group-cover-2.jpg" alt="">
                        <div class="card-overly"></div>
                    </div>
                </a>
                <div class="card-body">
                    ...
                    <div class="flex gap-2">
                        <button type="button"
                            class="button bg-primary-soft text-primary flex-1">Join</button>
            ...
            <div class="card">
                <a href="timeline-group.html">
                    <div class="card-media h-24">
                        <img src="main_assets/images/group/group-cover-1.jpg" alt="">
                        <div class="card-overly"></div>
                    </div>
                </a>
                <div class="card-body">
            ...
            <div class="card">
                <a href="timeline-group.html">
                    <div class="card-media h-24">
                        <img src="main_assets/images/group/group-cover-3.jpg" alt="">
                        <div class="card-overly"></div>
                    </div>
                </a>
                <div class="card-body">
    ...
    <!-- category title -->
    <div class="hidden sm:my-6 my-3 flex items-center justify-between">
        <div>
    ...
    <!-- group  slider -->
    <div class="hidden " tabindex="-1" uk-slider="finite:true">
        ...
        <div class="uk-slider-container pb-1">
            ...
            <ul class="uk-slider-items grid-small">
                ...
                <li class="md:w-1/5 sm:w-1/3 w-1/2">
                    <a href="#">
                        <div class="relative rounded-lg overflow-hidden">
                            <img src="main_assets/images/category/Buy-and-sell.html" alt="" class="h-36 w-full object-cover">
                ...
                <li class="md:w-1/5 sm:w-1/3 w-1/2">
                    <a href="#">
                        <div class="relative rounded-lg overflow-hidden">
                            <img src="main_assets/images/category/health.jpg" alt="" class="h-36 w-full object-cover">
                            <div class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                ...
                <li class="md:w-1/5 sm:w-1/3 w-1/2">
                    <a href="#">
                        <div class="relative rounded-lg overflow-hidden">
                            <img src="main_assets/images/category/science-and-tech.jpg" alt=""
                ...
                <li class="md:w-1/5 sm:w-1/3 w-1/2">
                    <a href="#">
                        <div class="relative rounded-lg overflow-hidden">
                            <img src="main_assets/images/category/travel.jpg" alt="" class="h-36 w-full object-cover">
                            <div class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                ...
                <li class="md:w-1/5 sm:w-1/3 w-1/2">
                    <a href="#">
                        <div class="relative rounded-lg overflow-hidden">
                            <img src="main_assets/images/category/business.jpg" alt="" class="h-36 w-full object-cover">
                            <div class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
    ...
    <!-- suggest title -->
    <div class="hidden  sm:my-6 my-3 flex items-center justify-between lg:mt-10">
        <div>
    ...
    <div class="hidden grid md:grid-cols-2 md:gap-2 gap-3">
        ...
        <div class="flex md:items-center space-x-4 p-4 rounded-md box">
            <div class="sm:w-20 w-14 sm:h-20 h-14 flex-shrink-0 rounded-lg relative">
                <img src="main_assets/images/group/group-4.jpg"
                    class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm" alt="">
            </div>
            <div class="flex-1">
                <a href="timeline-group.html"
                    class="md:text-lg text-base font-semibold capitalize text-black"> Delicious Foods
                </a>
                ...
                <div class="flex items-center mt-2">
                    <img src="main_assets/images/avatars/avatar-2.jpg"
                        class="w-6 rounded-full border-2 border-gray-200 -mr-2" alt="">
                    <img src="main_assets/images/avatars/avatar-4.jpg" class="w-6 rounded-full border-2 border-gray-200"
                        alt="">
                    <div class="text-sm text-gray-500 ml-2"> 14 friends are members</div>
                </div>

            </div>
            <button type="button" class="button bg-primary-soft text-primary gap-1 max-md:hidden">
        ...
        <div class="flex md:items-center space-x-4 p-4 rounded-md box">
            <div class="sm:w-20 w-14 sm:h-20 h-14 flex-shrink-0 rounded-lg relative">
                <img src="main_assets/images/group/group-3.jpg"
                    class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm" alt="">
            </div>
            <div class="flex-1">
                <a href="timeline-group.html"
                    class="md:text-lg text-base font-semibold capitalize text-black"> Abstract minimal
                </a>
                <div class="flex space-x-2 items-center text-sm font-normal">
                    <div> 18K Members</div>
                    <div>·</div>
        ...
        <div class="flex md:items-center space-x-4 p-4 rounded-md box">
            <div class="sm:w-20 w-14 sm:h-20 h-14 flex-shrink-0 rounded-lg relative">
                <img src="main_assets/images/group/group-2.jpg"
                    class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm" alt="">
            </div>
            <div class="flex-1">
                <a href="timeline-group.html"
        ...
        <div class="flex md:items-center space-x-4 p-4 rounded-md box">
            <div class="sm:w-20 w-14 sm:h-20 h-14 flex-shrink-0 rounded-lg relative">
                <img src="main_assets/images/group/group-1.jpg"
                    class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm" alt="">
            </div>
            <div class="flex-1">
                <a href="timeline-group.html"
                    class="md:text-lg text-base font-semibold capitalize text-black"> Graphic Design
                </a>
                <div class="flex space-x-2 items-center text-sm font-normal">
                    <div> 24K Members</div>
                    <div>·</div>
    ...
    <div class="hidden flex justify-center my-6">
        <button type="button" class="bg-white py-2 px-5 rounded-full shadow-md font-semibold text-sm">Load
            more...</button>
    </div>
