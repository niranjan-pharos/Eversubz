...
<style>
  ...
  #enquiries-table_filter{display: none;}
...
<section class="bookmark-part" style="margin: 0px 20px;">
    <div class="container">
        <div class="row">
...
<script>
  $(document).ready(function(){$('#enquiries-table').DataTable({"paging":!0,"searching":!0,"ordering":!0,"info":!0});$('.delete-enquiry').on('click',function(){var enquiryId=$(this).data('enquiry-id');var row=$('#enquiry-row-'+enquiryId);if(confirm('Are you sure you want to delete this enquiry?')){$.ajax({url:'{{ url('events/enquiries') }}/'+enquiryId,method:'DELETE',data:{_token:'{{ csrf_token() }}'},success:function(response){if(response.success){row.fadeOut(300,function(){row.remove()});alert(response.success)}else{alert('Failed to delete enquiry.')}},error:function(xhr,status,error){console.error(error)}})}})})
</script>
@endsection
