    ...
    <div class="tab-content">
        ...
        <div class="row">
            <div class="col float-right ml-auto">
                <a href="{{ route('blogs')}}" class="btn btn-primary mb-3" style="float:right"><i class="fa fa-mail-reply"></i> Blogs List </a>
            </div>
            <div class="col-md-12">
                <div class="card mb-0">
                    <div class="card-body">
                    <form action="{{ route('adminBlogStore') }}" enctype="multipart/form-data" method="post" role="form" id="add_blog">
                            @csrf
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-form-label">Alt Text <span class="text-danger">*</span></label>
                                            <input class="form-control" type="text" name="alt_text" id="alt_text" required>
                                        </div>
                                    </div>

                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="col-form-label">Blog Image <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="col-form-label">Event Description <span class="text-danger">*</span></label>
                                            <textarea class="form-control" id="blogDescription" placeholder="Write Blog" name="blog_description" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    document.getElementById('add_blog').addEventListener('submit', function(event) {
        ...
        if (imageInput.files.length > 0) {
            ...
            var newFile = new File([imageFile], newFileName, {type: imageFile.type});
